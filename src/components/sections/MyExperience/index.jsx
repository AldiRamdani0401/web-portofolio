...
const MyExperience = () => {
  return (
    <section id="my-experience" className="h-dvh w-full snap-center">
      ...
      <div className="flex flex-row justify-center h-fit py-10 relative bg-zinc-950">
        <div className="flex flex-col justify-center align-middle px-0 w-full lg:w-1/2 h-full self-center">
          <div className=" py-3 px-5 lg:p-5 text-white rounded-lg">
      ...
      <div className="flex flex-row justify-center h-fit py-10 relative bg-zinc-950">
        <div className="flex flex-col justify-center align-middle px-0 w-full lg:w-1/2 h-full self-center">
          <div className=" p-5 text-white rounded-lg">
            ...
            <p className="mb-4 text-justify">
              <span className="ml-8">{languageMap()["sub-content"][5][5]}</span>
            </p>

            <p className="mb-4 text-justify">
              <span className="ml-8">{languageMap()["sub-content"][5][6]}</span>
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-row justify-center h-fit py-10 relative bg-zinc-950">
        <div className="flex flex-col justify-center align-middle px-0 w-full lg:w-1/2 h-full self-center">
          <div className=" p-5 text-white rounded-lg">
            ...
            <p className="mb-4 text-justify">
              <span className="ml-8">{languageMap()["sub-content"][6][6]}</span>
            </p>
            <p className="mb-4 text-justify">
