...
const Carousel = () => {
  return (
    <div className="bg-gray-950 w-full h-fit flex gap-16 flex-col md:flex-row lg:flex-row xl:flex-row justify-around">
      ...
      <div className="relative bottom-0 md:bottom-0 lg:bottom-0 h-130 w-full md:h-fit md:w-fit animate-fadeIn mx-0 md:mx-16">
        <div className="relative h-full w-full z-10 ">
          ...
          <img className="z-10 h-full px-5 mx-auto md:pt-[76px] lg:md:pt-[76px]" src={hero} alt="aldi-ramdani" />
        </div>
      </div>
    </div>
  );
