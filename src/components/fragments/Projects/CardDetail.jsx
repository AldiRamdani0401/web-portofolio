      ...
      <div className="flex flex-col-reverse lg:flex-row justify-between bg-white rounded-lg p-2 shadow-lg h-[90%] w-[90%] lg:h-fit lg:w-[90%] gap-1 relative">
        ...
        <div className="flex flex-col-reverse align-start lg:flex-row w-full h-full lg:h-full gap-2">
          ...
          <div className="w-full h-full overflow-hidden flex flex-col px-2 select-none relative">
            {/* Max Mobile */}
            <div className={`${minMax() ? 'block' : 'hidden'} lg:hidden relative left-0 top-0 my-1 border rounded-md`}>
              <button
              ...
              >
                {minMax() && (
                  ...
                  <div className="flex">
                    ...
                    <span className="self-center text-sm">open documentation image</span>
                  </div>
                )}
              </button>
            </div>
            {/* Tab Buttons */}
            <div className={`${minMax() ? 'h-7' : 'h-10'} flex gap-1 lg:h-fit max-w-full overflow-x-auto scrollbar-hide overflow-y-hidden`}>
              <button
                id="#overview"
            ...
            <div className="grid grid-flow-col auto-cols-max justify-start max-w-full max-h-full overflow-auto lg:w-full gap-2 lg:gap-3 snap-x snap-mandatory scrollbar-hide scroll-smooth px-2">
              ...
              <div
                id="overview"
                className="w-[322px] max-h-150 overflow-y-scroll lg:w-[606px] snap-center"
              >
                {/* Header */}
                ...
                <div className="w-full">
                  ...
                  <div className="flex flex-col text-md font-semibold">
                    ...
                    <div className="text-sm font-normal text-justify border p-4 lg:px-3 py-2">
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis voluptatum a culpa laudantium perspiciatis rem nulla, obcaecati at vero quis quod corrupti! Ad culpa dolore laboriosam exercitationem, tempora corporis aliquam, autem vel et eos maiores perspiciatis officiis expedita ullam accusantium quidem totam eveniet sunt adipisci dolorum obcaecati. Tempore, totam facere fuga aliquam aspernatur eveniet impedit est perspiciatis fugiat voluptatem deserunt dolorum quis. Deleniti dicta voluptatum, reprehenderit eaque quis, nemo consequatur sunt officia minima quaerat illo harum quidem deserunt eum voluptates similique modi mollitia beatae. Blanditiis molestiae incidunt eligendi, expedita minus praesentium itaque rem necessitatibus quia deserunt possimus delectus sequi officia.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col text-md font-semibold">
                    ...
                    <div className="text-sm font-normal align-middle border">
                      <div className="flex gap-1 py-1 px-2 justify-center border">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium non molestias, ullam, ipsam molestiae eligendi quaerat nobis hic repellendus alias quod similique! Repellat veritatis, ratione delectus quidem aut maiores iusto?</p>
                      </div>
                      <div className="flex gap-1 py-1 px-2 justify-center border">
                        <span className="p-1 rounded-full bg-blue-900 h-fit w-fit mt-1"></span>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium non molestias, ullam, ipsam molestiae eligendi quaerat nobis hic repellendus alias quod similique! Repellat veritatis, ratione delectus quidem aut maiores iusto?</p>
          ...
          {/* Image Project */}
          <div className={`${minMax() ? 'hidden' : 'flex'} flex-row justify-between items-center w-full h-full relative border`}>
            {/* Tombol Prev */}
